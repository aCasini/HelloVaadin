...
public class MainView extends VerticalLayout implements View {
	...
	class ButtonListener implements ClickListener {
		...
		public void buttonClick(ClickEvent event) {
			...
			navigator.navigateTo(HellovaadinUI.MAINVIEW + "/" + menuitem);
		}
	}
	...
	public MainView() {
		...
		menuContent.addComponent(new Button("Moore", new ButtonListener("moore")));
		menuContent.addComponent(new Button("Capricorn", new ButtonListener("capricorn")));
